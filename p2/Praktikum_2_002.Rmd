...
data <- read_excel("C:\\Users\\adipr\\Documents\\KULIAH\\Semester 4\\Anreg\\Praktikum 2\\NSC-2025.xlsx", sheet="Sheet2")
...
$$\hat{Y} = -10.70937 +  0.93703 X_7$$

dengan Y adalah persentase penduduk miskin dan X7 adalah Pertumbuhan Ekonomi Sektor Industri Pengolahan.

Didapatkan nilai $\hat\beta_0 = −10.70937$ artinya nilai dugaan rataan variabel respon ketika variabel penjelas bernilai 0 adalah sebesar −10.70937%. Namun, karena nilai 0 tidak terdapat dalam selang pengamatan variabel penjelas, maka $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_1 = 0.93703$ artinya setiap kenaikan satu satuan pada variabel penjelas akan menyebabkan kenaikan dugaan rataan variabel respon sebesar 0.93703%, dengan asumsi faktor lain dianggap konstan.

Koefisien determinasi yang dihasilkan adalah 0.5066 atau 50.66%, artinya sebesar 50.66% keragaman variabel respon dapat dijelaskan oleh variabel penjelas yang digunakan dalam model, sedangkan sisanya sebesar 49.34% dijelaskan oleh peubah lain yang tidak dimasukkan ke dalam model.
